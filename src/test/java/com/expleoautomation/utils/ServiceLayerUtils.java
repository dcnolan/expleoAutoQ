...
import com.expleoautomation.utils.ServiceLayerUtils.MyResponse.Detail;
...
public class ServiceLayerUtils {
	...
	public static Response request(String action, String resource, String body)  {
		...
		if (StringUtils.isJson(responseString)) {
			MyResponse responseObj = new ServiceLayerUtils().new MyResponse().fromJsonString(responseString);
			// success
